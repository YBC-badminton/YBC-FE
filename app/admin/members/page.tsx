                        ...
                        {filteredMembers.map((m) => (
                            <tr key={m.memberId} className="hover:bg-gray-50">
                                {editingId === m.memberId ? (
                                    ...
                                    <>
                                        <td className="p-4 font-bold w-24"><p className="border">{m.name}</p></td>
                                        <td className="p-4 w-16"><p className="border">{GENDER_LABEL[m.gender]}</p></td>
                                        <td className="p-4 w-20"><p className="border">{m.age}년생</p></td>
                                        <td className="p-4 w-32"><p className="border">{m.university}</p></td>
                                        <td className="p-4 w-20"><p className="border">{m.term}</p></td>
                                        <td className="p-4 w-40"><p className="border">{m.phone}</p></td>
                                        <td className="p-4 w-40 truncate"><p className="border">{m.email}</p></td>
                                        <td className="p-4 w-16 text-center"><p className="border">{m.isMapoResident ? 'O' : 'X'}</p></td>
