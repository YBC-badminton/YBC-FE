...
// --- 인터페이스 정의 (백엔드 Success Response 규격 반영) ---
interface Review {
    reviewId: number; 
...
// ISO 날짜 데이터를 가독성 좋은 포맷으로 정제 ("2026-03-15T14:30:00" -> "2026.03.15")
...
export default function ReviewPage() {
    ...
    const fetchReviews = useCallback(async () => {
        ...
        setError(null);
        try {
            // [핵심 해결 포인트] sort 규격을 백엔드 명세가 강제하는 단일 문장 'desc'로 전면 수정합니다.
